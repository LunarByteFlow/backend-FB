    ...
    if (!Username || !Email || !Password || !ContactNo) {
        ...
        try {
            ...
            if (CheckUser) {
                ...
                await User.create({ Username, Email,ContactNo, Password: await hash(Password, 12) })
...
module.exports = { Login, Register, deleteUser, userByEmail, updateProfile, userByID, getAllUsers }